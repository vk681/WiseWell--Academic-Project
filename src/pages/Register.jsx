...
export default function EventCreation() {
  ...
  async function addPhotoByLink(ev) {
    try {
      ...
      // You can set an error state, show an error message, etc.
    }
  }
    ...
    <div className="w-3/5 flex mt-14 m-auto font-thin bg-lightGray rounded-lg px-2 py-2">
      <form className="flex w-full font-sans " onSubmit={handleCreate}>
        <div className="ml-10 w-3/5 flex flex-col gap-2 ">
          <h1 className="text-xl font-thin">1. Enter your name</h1>
          ...
          <input
            ...
            className="ml-2 bg-gray-100 px-4 py-2 text-gray-800 flex-1 rounded-lg border-none shadow-sm focus:outline-none focus:ring-2  "
            type="text"
            placeholder="give your home address"
            value={address}
          ...
          <div className="flex  mt-2 gap-8">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-thin   ">6. Choose yoyr type</h1>
              <select
                id="type"
                name="type"
        ...
        <div className="ml-10 p-5 w-2/5 flex flex-col gap-3  ">
          <div className="mt-2">
            <h1 className="text-xl font-thin">8. Enter your email</h1>
            <input
              id="email"
              name="email"
              className="ml-2 bg-gray-100 px-4 py-2 text-gray-800 flex-1 rounded-lg border-none shadow-sm focus:outline-none focus:ring-2  "
            ...
            />
            <h1 className="text-xl font-thin">9. Enter your password</h1>
            <input
              id="pwd"
              name="pwd"
              className="ml-2 bg-gray-100 px-4 py-2 text-gray-800 flex-1 rounded-lg border-none shadow-sm focus:outline-none focus:ring-2  "
